...
### 📖 [Documentation officielle](https://docs.newapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://github.com/500wango/arcmux)
...
- 🔍 Requête de quota d'utilisation de clé (avec [new-api-key-tool](https://github.com/500wango/arcmux-key-tool))
...
> [!TIP]
> **Dernière image Docker:** `500wango/arcmux:latest`
...
| Projet | Description |
|------|------|
| [new-api-key-tool](https://github.com/500wango/arcmux-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [new-api-horizon](https://github.com/500wango/arcmux-horizon) | Version optimisée haute performance de New API |
...
Si les politiques de votre organisation ne permettent pas l'utilisation de logiciels sous licence AGPLv3, ou si vous souhaitez éviter les obligations open-source de l'AGPLv3, veuillez nous contacter à : [https://github.com/500wango/arcmux/issues](mailto:https://github.com/500wango/arcmux/issues)
...
**[Documentation officielle](https://docs.newapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/500wango/arcmux/issues)** • **[Dernière version](https://github.com/500wango/arcmux/releases)**

<sub>Construit avec ❤️ par les contributeurs d'ArcMux</sub>
