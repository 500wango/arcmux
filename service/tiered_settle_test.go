...
import (
	...
	kittypes "github.com/500wango/arcmux/relaykit/types"
...
func TestPrepareTieredBillingForSelectedGroupRejectsInsufficientReserve(t *testing.T) {
	truncate(t)

	const userID = 701
	// Balance covers the initial pre-consume but not the extra reservation for
	// the more expensive retry group. The request must stop before upstream send.
