...
export function Footer(props: FooterProps) {
  ...
  const displayLogo = systemLogo || props.logo || '/logo-icon.svg'
  const displayName = systemName || props.name || 'ArcMux'
    ...
    () => [
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: 'https://github.com/500wango/arcmux/issues',
          },
          {
        ...
        links: [
          {
            ...
            href: 'https://github.com/500wango/arcmux#quick-start',
          },
          {
            text: t('footer.columns.docs.links.installation'),
            href: 'https://github.com/500wango/arcmux#deployment',
          },
          {
            text: t('footer.columns.docs.links.apiDocs'),
            href: 'https://github.com/500wango/arcmux#api',
          },
        ],
      },
      {
