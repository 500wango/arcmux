...
export function SectionPageLayout(props: SectionPageLayoutProps) {
  ...
  return (
    <PageFooterProvider container={footerContainer}>
      <Main>
        <div className='shrink-0 px-3 pt-4 pb-3 sm:px-5 sm:pt-5 sm:pb-3'>
          {breadcrumb != null && (
        ...
        <div
          className={
            props.fixedContent
              ? 'min-h-0 flex-1 overflow-hidden px-3 pt-1 pb-3 sm:px-5 sm:pt-1.5 sm:pb-4'
              : 'min-h-0 flex-1 overflow-auto px-3 pt-1 pb-3 sm:px-5 sm:pt-1.5 sm:pb-4'
          }
        >
          {content}
        </div>
        ...
        <div
          ...
          className='bg-background shrink-0 border-t px-3 py-3 sm:px-5 sm:py-3'
        />
      </Main>
    </PageFooterProvider>
  )
