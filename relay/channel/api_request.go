...
var passthroughSkipHeaderNamesLower = map[string]struct{}{
	...
	// Grok/xAI CLI handshake headers are only valid for the xAI CLI proxy.
	// Never forward client-supplied copies to third-party OpenAI-compatible
	// upstreams when wildcard or regex passthrough is enabled.
	"x-xai-token-auth":         {},
