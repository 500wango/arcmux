...
import (
	...
	"github.com/500wango/arcmux/service/authz"
...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/:id/oauth/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartChannelUpstreamOAuth},
	{method: http.MethodGet, path: "/:id/oauth/sessions/:session_id", permission: authz.ChannelRead, handler: controller.GetChannelUpstreamOAuthSession},
	{method: http.MethodPost, path: "/:id/oauth/sessions/:session_id/callback", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteChannelUpstreamOAuth},
	{method: http.MethodPost, path: "/:id/oauth/sessions/:session_id/poll", permission: authz.ChannelSensitiveWrite, handler: controller.PollChannelUpstreamOAuth},
	{method: http.MethodDelete, path: "/:id/oauth/sessions/:session_id", permission: authz.ChannelSensitiveWrite, handler: controller.CancelChannelUpstreamOAuth},
	{method: http.MethodGet, path: "/:id/oauth/credentials", permission: authz.ChannelRead, handler: controller.ListChannelUpstreamCredentials},
	{method: http.MethodPost, path: "/:id/oauth/credentials/import", permission: authz.ChannelSensitiveWrite, handler: controller.ImportChannelUpstreamCredentials},
	{method: http.MethodPost, path: "/:id/oauth/credentials/:credential_id/refresh", permission: authz.ChannelSensitiveWrite, handler: controller.RefreshChannelUpstreamCredential},
	{method: http.MethodPut, path: "/:id/oauth/credentials/:credential_id/status", permission: authz.ChannelSensitiveWrite, handler: controller.UpdateChannelUpstreamCredential},
	{method: http.MethodDelete, path: "/:id/oauth/credentials/:credential_id", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteChannelUpstreamCredential},
