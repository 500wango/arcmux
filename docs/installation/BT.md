...
本文档提供使用宝塔面板 Docker 功能部署 ArcMux 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/ArcMux`
...
services:
  ArcMux:
    image: calciumion/ArcMux:latest
    container_name: ArcMux
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
```bash
# 拉取最新镜像
docker pull calciumion/ArcMux:latest
...
- [GitHub 仓库](https://github.com/500wango/arcmux)
