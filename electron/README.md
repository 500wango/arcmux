# ArcMux Electron Desktop App

This directory contains the Electron wrapper for ArcMux, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/ArcMux/data/`
  - Windows: `%APPDATA%/ArcMux/data/`
  - Linux: `~/.config/ArcMux/data/`
