...
func printHelp() {
	fmt.Println("ArcMux " + Version + " - The next-generation LLM gateway and AI asset management system.")
	fmt.Println("Maintainer: ArcMux contributors - https://github.com/500wango/arcmux")
	fmt.Println("Usage: arcmux [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
